...
function DeskManagement() {
  ...
  <div style={{ paddingTop: "250px" }}>
      ...
      <h3>Create Desk</h3>
      <input id="desk_create_name" placeholder="desk_code, zone_id, features, status" style={{borderColor: 'teal', borderWidth: '1.5px', borderRadius: '5px'}}/>
...
>
      ...
      <h3>Update Desk</h3>
      <input id="up_desk_id" placeholder="Desk ID" style={{marginRight: 5, borderColor: 'teal', borderWidth: 1.5, borderRadius: '5px'}} />
      <input id="up_zone_id" placeholder="New Zone ID" style={{marginRight: 5, borderColor: 'teal', borderWidth: 1.5, borderRadius: '5px'}}/>
      <input id="up_desk_code" placeholder="New Desk Code" style={{marginRight: 5, borderColor: 'teal', borderWidth: 1.5, borderRadius: '5px'}}/>
      <input id="up_features" placeholder="New Features" style={{marginRight: 5, borderColor: 'teal', borderWidth: 1.5, borderRadius: '5px'}}/>
      ...
      <h3>Delete Desk</h3>
      <input id="desk_delete_id" placeholder="Desk ID" style={{borderColor: 'teal', borderWidth: '1.5px', borderRadius: '5px'}} />
